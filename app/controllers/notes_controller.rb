class NotesController < ApplicationController
  ...
  before_action set_note: [:update, :destroy, :show]
  ...
  def update
    if @note.update(note_params)
      ...
      render json: {message: "Falha ao atulizar nota!"}, status: :unprocessable_entity
    end
  end
  ...
  private 
    def set_note
      ...
      @note = guest_user.guest_notes.find params[:id] unless @note.present?
    end
